...
gen pre_vac = 0
replace pre_vac = 1 if runiform() < (vac_at*0.1 + hs*0.05 + col*0.1 + grad*0.15 + liberal*0.2 - conservative*0.2 + age*0.001) 
...
merge 1:1 id using assignment.dta
drop _merge
